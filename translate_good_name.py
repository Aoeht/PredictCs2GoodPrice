...
NAME_LIST=["Ursus_Knife","Bowie_Knife","Nomad_Knife","Flip_Knife","jisheng_Knife","Huntsman_Knife","SealKnife","Gut","Butterfly"]
NAME_LIST_CN=["熊刀","鲍伊猎刀","流浪者匕首","折叠刀","系绳匕首","猎杀者匕首","海豹短刀","穿肠刀","蝴蝶刀"]
